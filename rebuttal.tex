...
\begin{reply}
Chapter 7 is actually based on two of our publication, do despite its title, it is indeed necessary. But we totally agree with the reviewer and move the appendix after the bibliography.
\end{reply}
